  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          "bg-background pointer-events-none block size-4 rounded-full ring-0 shadow-sm transition-transform data-checked:translate-x-4 data-unchecked:translate-x-0.5",
        )}
      />
    </SwitchPrimitive.Root>
  );
